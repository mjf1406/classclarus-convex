...
const ru: Catalog = {
  ...
  auth: {
    ...
    passwordAuthNote:
      'Обратитесь к администратору сайта, если нужно сбросить пароль. Самостоятельного восстановления по почте нет.',
    emailLabel: 'Эл. почта',
    ...
    signUpInstead: 'Нет аккаунта? Зарегистрироваться',
