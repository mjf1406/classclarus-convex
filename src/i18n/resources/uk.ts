...
const uk: Catalog = {
  ...
  auth: {
    ...
    passwordAuthNote:
      'Зверніться до адміністратора сайту, якщо потрібно скинути пароль. Самостійного відновлення електронною поштою немає.',
    emailLabel: 'Ел. пошта',
    ...
    nameLabel: 'Імʼя',
    namePlaceholder: 'Відображуване імʼя (необовʼязково)',
    signInWithPassword: 'Увійти',
    signUpWithPassword: 'Створити обліковий запис',
    signUpInstead: 'Немає облікового запису? Зареєструватися',
    signInInstead: 'Вже є обліковий запис? Увійти',
    invalidEmail: 'Введіть дійсну адресу ел. пошти.',
    passwordTooShort: 'Пароль має містити щонайменше 8 символів.',
    passwordsDoNotMatch: 'Паролі не збігаються.',
    authFailed: 'Не вдалося увійти. Перевірте пошту та пароль.',
  },
  pwa: {
