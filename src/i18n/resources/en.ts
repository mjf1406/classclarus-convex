const en = {
  ...
  auth: {
    ...
    passwordAuthNote:
      'Ask your site administrator if you need your password reset. There is no self-service email recovery.',
    ...
    authFailed: 'Could not sign in. Check your email and password.',
  },
  pwa: {
  ...
  schools: {
    ...
    inviteDescription:
      'Create a time-limited invite so colleagues can join as principal, vice principal, teacher, or admin. Invites expire within 72 hours for security.',
  ...
  classes: {
    ...
    joinCodesDescription:
      'Create a time-limited invite so others can join this class with the matching role. Invites expire within 72 hours to reduce the risk of leaked codes exposing student or guardian information.',
